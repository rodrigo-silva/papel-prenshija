 ...
 *
 */
public class LaNacionNewsPaperTemplateData extends AbstractNewsPaperTemplateData {

   public LaNacionNewsPaperTemplateData() {
      super();
   }
   ...
   protected BackgroundTemplate getInternalBackgroundTemplate() {
      ...
      final BackgroundTemplate backgroundTemplate =
               new BackgroundTemplate(TEMPLATE_BASE_DIR + "lanacion.jpg", pictureScale, pictureCoordinates);
